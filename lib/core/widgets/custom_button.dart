  ...
  Widget build(BuildContext context) {
    ...
    return ElevatedButton(
      ...
      style: ElevatedButton.styleFrom(
        ...
        shape: shape ??
            RoundedRectangleBorder(
              borderRadius: BorderRadius.all(Radius.circular(borderRadius??Sizes.buttonR24)),
            ),
        elevation: elevation ?? 0,
        backgroundColor: buttonColor,
        foregroundColor: splashColor,
        shadowColor: shadowColor,
        // fixedSize: Size(fixedWidth??Sizes.buttonWidth60, fixedHeight??Sizes.buttonHeight40),
        minimumSize: Size(
      ...
      child: Container(
        ...
        width: width ?? Sizes.buttonWidth240,
